...
namespace BTLQLCHBS.Class
{
    class Functions
    {
        public static SqlConnection Conn; //Khai báo đối tượng kết
                                          //nối
        public static string connString; //Khai báo biến chứa
                                         //chuỗi kết nối

        public static void Connect()
        {
            connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\baitaioncslt2\BTLQLCHBS\databasechbs\cuahangbansach.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        public static DataTable GetDatatoTable2(string sql)
        {
