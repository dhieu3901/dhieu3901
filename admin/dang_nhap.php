...
<html lang="en">
    <head>
        ...
        function Kiemtramk() {
            // lấy giá trị từ ô tài khoản
            var email = document.getElementById("txtEmail").value;

            // Kiểm tra xem ô tài khaorn có rỗng hay không?
            if(email == "")
            {
                window.alert("! Email không được để trống");
                return false;
                }
            // lấy giá trị từ ô mật khẩu

            var mat_khau = document.getElementById("txtMatKhau").value;
            if(mat_khau == ""){
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="dang_nhap_kiem_tra.php" onsubmit="return(Kiemtramk())" >
