                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Danh sách vaccine | <a class="btn btn-warning" href="../admin/vaccine_them_moi.php" style="float: right; margin-right: 14px">Thêm mới <i class="fas fa-plus-circle"></i></a>                      
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    ;?>
                                        <tr>
                                            ...
                                            <td style="text-align: center; "><a class="btn btn-info" href="vaccine_sua.php?id=<?php echo $row['vaccine_id'];?>">Sửa</a></td>
                                            <td style="text-align: center; "><a class="btn btn-danger" href="vaccine_xoa.php?id=<?php echo $row['vaccine_id'];?>">Xóa</a></td>
                                        </tr>
                                    <?php
                                    }
