...
<body>
    ...
    <!--================End Header Area =================-->
      ...
      <div class="container">
        <div class="breadcrumb_text">
          <h6 class="wow fadeInUp">Bản đồ dịch tễ COVID-19 Hà Nội</h6>
          <h3 class="wow fadeInUp" data-wow-delay="0.2s">Bản đồ dịch tễ COVID-19 Hà Nội</h3>
          <ul class="nav justify-content-center wow fadeInUp" data-wow-delay="0.3s">
            <li><a href="index.php">Trang chủ</a></li>
            <li><a href="prevention.php">Phòng chống</a></li>
            <li><a href="symptom.php">Bản đồ dịch tễ Hà Nội</a></li>
          </ul>
        </div>
      </div>
    </section>
    <!--================End Breadcrumb Area =================-->
        <!--================Corona Map Area =================-->
        <section class="map_tracker">
            <div class="">
                <iframe src="https://covidmaps.hanoi.gov.vn/?page=home"
                    width="1528" height="750" style="border:0;" allowfullscreen="" loading="lazy">
                </iframe>
            </div>
        </section>
        <!--================End Corona Map Area =================-->
